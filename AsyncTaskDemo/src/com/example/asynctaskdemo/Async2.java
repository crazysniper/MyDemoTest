...
public class Async2 extends Activity {

	private static final String TAG = "ASYNC_TASK";

	private Button execute, getStatus;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getStatus.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				System.out.println("状态1=" + mTask.getStatus());// PENDING、RUNNING、FINISHED
				System.out.println("状态2=" + mTask.isCancelled());// true;false
			}
		});
