...
public class CodeMainActivity extends Activity implements Callback, OnClickListener {
	...
	public void handleDecode(Result obj, Bitmap barcode) {
		...
		/*
		 * if (obj.getBarcodeFormat().toString().equals("QR_CODE")) { Uri uri =
		 * Uri.parse(obj.getText()); Intent intent=new
