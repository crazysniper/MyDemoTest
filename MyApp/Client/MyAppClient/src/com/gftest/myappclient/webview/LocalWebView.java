...
public class LocalWebView extends BaseActivity implements OnClickListener {
	...
	public class JavascriptInterface {
		...
		public void openDialog() {
			builder = new AlertDialog.Builder(LocalWebView.this);
			builder.setTitle("由网页打开android里的对话框");
			builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
				@Override
				public void onClick(DialogInterface dialog, int which) {
					dialog.dismiss();
					Toast.makeText(LocalWebView.this, "点击的是确定", Toast.LENGTH_SHORT).show();
				}
			});
