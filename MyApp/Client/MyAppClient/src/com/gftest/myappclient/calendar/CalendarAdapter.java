...
public class CalendarAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tView.setTextColor(context.getResources().getColor(R.color.unchose2));
		if (position < daysOfMonth + dayOfWeek && position >= dayOfWeek) {
			// 当前月信息显示
			holder.tView.setTextColor(context.getResources().getColor(R.color.chose));// 当月
		}
		...
		if (currentFlag == position) {
			...
			// holder.icon.setImageResource(R.drawable.red_flower);
			holder.main.setBackgroundColor(context.getResources().getColor(R.color.chose));
		} else {
			holder.tView.setTextColor(context.getResources().getColor(R.color.chose));
