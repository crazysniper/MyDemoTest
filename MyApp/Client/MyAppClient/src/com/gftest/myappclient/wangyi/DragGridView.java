...
public class DragGridView extends GridView {
	...
	private CheckGridViewData checkGridViewData;
	...
	public DragGridView(Context context, AttributeSet attrs, int defStyle) {
		...
		mStatusHeight = Utils.getStatusBarHeight(context); // 获取状态栏的高度
	...
	private void onSwapItem(int moveX, int moveY) {
		...
		if (tempPosition != mDragPosition && tempPosition != AdapterView.INVALID_POSITION && mAnimationEnd) {
			checkGridViewData.setChecked(true);
	...
	public void setCheckGridViewData(CheckGridViewData checkGridViewData) {
		this.checkGridViewData = checkGridViewData;
	}

	public interface CheckGridViewData {
