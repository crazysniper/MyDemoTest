...
public class MatchView extends View {
	...
	private void initView() {
		...
		MatchTextUtils.init(getContext());
		mLineWidth = MatchTextUtils.dp2px(1);
		mDropHeight = MatchTextUtils.dp2px(40);
		horizontalRandomness = MatchTextUtils.SCREEN_WIDTH_PIXELS / 2;

		setPadding(0, MatchTextUtils.dp2px(mPaddingTop), 0, MatchTextUtils.dp2px(mPaddingTop));
	...
	private int getTopOffset() {
		return getPaddingTop() + MatchTextUtils.dp2px(10);
	}

	private int getBottomOffset() {
		return getPaddingBottom() + MatchTextUtils.dp2px(10);
	}
	...
	public void initWithPointList(ArrayList<float[]> pointList) {
		...
		for (int i = 0; i < pointList.size(); i++) {
			...
			PointF startPoint = new PointF(MatchTextUtils.dp2px(line[0]) * mScale, MatchTextUtils.dp2px(line[1]) * mScale);
			PointF endPoint = new PointF(MatchTextUtils.dp2px(line[2]) * mScale, MatchTextUtils.dp2px(line[3]) * mScale);
