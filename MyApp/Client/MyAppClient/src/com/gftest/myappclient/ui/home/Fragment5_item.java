...
public class Fragment5_item extends BaseFragment {
	...
	public Fragment5_item() {
	}

	public Fragment5_item(String id) {
		this.id = id;
	}

	public Fragment5_item(String id, Activity activity) {
		this.id = id;
	...
	public void setUserVisibleHint(boolean isVisibleToUser) {
		...
		if (getView() != null) {
			System.out.println("setUserVisibleHint  getView不为空____id=" + id);
			isViewShown = true;
			// fetchData();
		} else {
			System.out.println("setUserVisibleHint  getView为空____id=" + id);
			isViewShown = false;
		}
		...
		if (getUserVisibleHint()) {
			...
			if (activity == null) {
				...
				System.out.println("aaaaaaaaaaaaaa" + "__index=" + id);
			} else {
				System.out.println("bbbbbbbbbbbbbbb" + "__index=" + id);
			}

			if (isVisibleToUser) {
				if (!hasdLoaded2) {
					System.out.println("111111111111111111" + "__index=" + id);
					hasdLoaded2 = true;
					// if (jsonObject != null &&
					// jsonObject.optString("ret").equals("1")) {
					// System.out.println("222222222222" + "__index=" + id);
					...
					System.out.println("4444444444" + "__index=" + id);
				}
			} else {
				if (!hasdLoaded) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		System.out.println("onCreateView_" + id);
		// isPrepared = true;
		// lazyLoad();
		return view;
	}
