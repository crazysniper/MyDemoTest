package com.gftest.myappclient.listener;
...
public class UpdateVersionMange {
	// 文件分隔符
	private static final String FILE_SEPARATOR = "/";
	// 外存sdcard存放路径
	private static final String FILE_PATH = Environment.getExternalStorageDirectory() + FILE_SEPARATOR + "myappclient" + FILE_SEPARATOR + "download" + FILE_SEPARATOR;
	// 下载应用存放全路径
	...
	public UpdateVersionMange(Context context) {
	...
	private void showNoticeDialog() {
		new AlertDialog.Builder(context).setTitle("软件版本更新").setMessage(message).setPositiveButton("下载", new OnClickListener() {
			@Override
