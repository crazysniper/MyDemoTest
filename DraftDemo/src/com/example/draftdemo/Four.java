...
public class Four extends Activity implements OnTouchListener, OnClickListener {
	...
	public void showWenAn(int position) {
		...
		// marginBottom);
		// layoutParams.setMargins(132, 209, 25, 209);
		...
		frame.addView(viewList.get(position));
		viewList.get(position).layout(marginLeft, marginTop, marginRight, marginBottom);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.dialog:
			AlertDialog.Builder dialog = new AlertDialog.Builder(Four.this);
