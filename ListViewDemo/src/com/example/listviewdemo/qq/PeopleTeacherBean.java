...
/**
 * 人物对象：教师 项目：聊天对话效果界面 包名：com.junhua.ceo.bean
 * 
 * @author Yuanjunhua
 * 
 *         2014-9-4上午11:01:23
...
public class PeopleTeacherBean extends Bean {
	...
	public PeopleTeacherBean(String tMessage, Integer portrait, String time, int id) {
		super();
		this.tMessage = tMessage;
		this.portrait = portrait;
		this.time = time;
	...
	public String toString() {
		return "PeopleTeacherBean [tMessage=" + tMessage + ", portrait=" + portrait + ", time=" + time + ", id=" + id + "]";
	}
