...
public class CropImageView3 extends View {
	...
	public int getTouchEdge(int eventX, int eventY) {
		if (mFloatDrawable.getBounds().left <= eventX && eventX < (mFloatDrawable.getBounds().left + mFloatDrawable.getCirleWidth()) && mFloatDrawable.getBounds().top <= eventY && eventY < (mFloatDrawable.getBounds().top + mFloatDrawable.getCirleHeight())) {
			return EDGE_LT;// 左上
		} else if ((mFloatDrawable.getBounds().right - mFloatDrawable.getCirleWidth()) <= eventX && eventX < mFloatDrawable.getBounds().right && mFloatDrawable.getBounds().top <= eventY && eventY < (mFloatDrawable.getBounds().top + mFloatDrawable.getCirleHeight())) {
			return EDGE_RT;// 右上
		} else if (mFloatDrawable.getBounds().left <= eventX && eventX < (mFloatDrawable.getBounds().left + mFloatDrawable.getCirleWidth()) && (mFloatDrawable.getBounds().bottom - mFloatDrawable.getCirleHeight()) <= eventY && eventY < mFloatDrawable.getBounds().bottom) {
			return EDGE_LB;// 左下
		} else if ((mFloatDrawable.getBounds().right - mFloatDrawable.getCirleWidth()) <= eventX && eventX < mFloatDrawable.getBounds().right && (mFloatDrawable.getBounds().bottom - mFloatDrawable.getCirleHeight()) <= eventY && eventY < mFloatDrawable.getBounds().bottom) {
			return EDGE_RB;// 右下
